...
export default async function klindosIn(branch, lang) {
  const spinner = ora();
  ...
  await executeCommand(`cp ~/config/vconsole.conf /mnt/etc/vconsole.conf`, spinner, lang);
  await executeCommand(`touch /mnt/root/branch`, spinner, lang);
